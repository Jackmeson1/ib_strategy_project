...
from ib_insync import IB, Contract, LimitOrder, MarketOrder, StopOrder, Trade as IBTrade

from src.config.settings import Config
from src.core.exceptions import (
    MarginError, OrderExecutionError, DataIntegrityError
)
from src.core.types import (
    Order, OrderAction, OrderStatus, Trade, ExecutionResult,
    RebalanceRequest
)
...
class SmartOrderExecutor:
    ...
    def _determine_order_type(self, order_value: float, symbol: str) -> OrderType:
        ...
        if order_value > 50000:  # Large orders use limit with wider spread
            return OrderType.LIMIT
        elif order_value > 10000:  # Medium orders use limit
            return OrderType.LIMIT
